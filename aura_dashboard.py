...
# Color Palette from Aura AI Dashboard
COLORS = {
    'primary': '#40E0D0',      # Turquoise
    'accent': '#FFA500',       # Orange
    'bg_light': '#FFD580',     # Light Orange
    'secondary': '#ADD8E6',    # Light Blue
    'dashboard_bg': '#FFF9F0', # Main BG
...
def create_main_layout():
    # Sidebar navigation
    sidebar = [
        [sg.Text('AURA AI', font=('Space Grotesk', 20, 'bold'), text_color=COLORS['accent'], background_color=COLORS['bg_light'], pad=(10, 20))],
        [sg.Button('Dashboard', key='-DASHBOARD-', size=(15, 1), button_color=(COLORS['text'], COLORS['secondary']), border_width=0)],
        [sg.Button('AI Assistant', key='-AI-', size=(15, 1), button_color=(COLORS['text'], COLORS['secondary']), border_width=0)],
        [sg.Button('AI Prompt Assist', key='-PROMPT-NAV-', size=(15, 1), button_color=(COLORS['text'], COLORS['secondary']), border_width=0)],
        [sg.Button('Task Organizer', key='-TASKS-', size=(15, 1), button_color=(COLORS['text'], COLORS['secondary']), border_width=0)],
        [sg.Button('Project Hub', key='-PROJECTS-', size=(15, 1), button_color=(COLORS['text'], COLORS['secondary']), border_width=0)],
        [sg.VPush(background_color=COLORS['bg_light'])],
        [sg.Button('Exit', size=(15, 1), button_color=('white', '#ef4444'), border_width=0)]
    ]
    ...
    layout = [
        [sg.Column(sidebar, background_color=COLORS['bg_light'], expand_y=True, pad=(0, 0)),
         sg.Column(content, background_color=COLORS['dashboard_bg'], expand_x=True, expand_y=True, pad=(0, 0))]
    ]
...
def create_dashboard_layout():
    return [
        [sg.Text('Welcome to Aura AI', font=('Space Grotesk', 24, 'bold'), text_color=COLORS['text'], background_color=COLORS['dashboard_bg'], pad=(20, 20))],
        [sg.Text('Select a module from the sidebar to get started.', font=('Inter', 12), text_color=COLORS['text'], background_color=COLORS['dashboard_bg'], pad=(20, 0))],
        [sg.Frame('', [
            [sg.Text('Quick Stats', font=('Inter', 14, 'bold'), background_color=COLORS['bg_light'])],
            [sg.Text('Active Projects: 4', background_color=COLORS['bg_light'])],
            [sg.Text('Tasks Pending: 12', background_color=COLORS['bg_light'])]
        ], background_color=COLORS['bg_light'], border_width=0, pad=(20, 40), expand_x=True)]
    ]
